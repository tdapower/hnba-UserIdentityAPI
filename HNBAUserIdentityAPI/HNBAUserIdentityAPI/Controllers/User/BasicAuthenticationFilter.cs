    ...
    public class BasicAuthenticationFilter : AuthorizationFilterAttribute
    {
        ...
        public override void OnAuthorization(HttpActionContext actionContext)
        {
            if (Active)
            {
                ...
                if (!OnAuthorizeUser(identity.Name, identity.Password, identity.Company, actionContext))
                {
                    Challenge(actionContext);
                    return;
                }
        ...
        /// <param name="actionContext"></param>
        /// <returns></returns>
        protected virtual bool OnAuthorizeUser(string username, string password, string company, HttpActionContext actionContext)
        {
        ...
        protected virtual BasicAuthenticationIdentity ParseAuthorizationHeader(HttpActionContext actionContext)
        {
            ...
            return new BasicAuthenticationIdentity(tokens[0], tokens[1], tokens[2]);
        }
